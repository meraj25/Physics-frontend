...
export function CreatePEContent({ heading: propHeading, headingName: propHeadingName, headingId: propHeadingId }) {
  const [createPEContent, { isLoading }] = useCreatePEContentMutation()
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await createPEContent(pecontent).unwrap()
    ...
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          ...
          <span className="text-xl font-medium">Add Pre-Engineering content</span>
        </button>
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-[625px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new pre-engineering content. The heading is preselected and read-only.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={onSubmit}>
          ...
          {showSuccess && (
            <Alert className="mt-4 border-green-500 text-green-700 bg-green-50">
              ...
              <AlertTitle>Success! Pre-Engineering content created</AlertTitle>
              <AlertDescription>The new pre-engineering content has been added.</AlertDescription>
            </Alert>
          )}
...
export default CreatePEContent
// ...existing code...