...
import { useGetAllPreEngHeadingsQuery } from "@/lib/api"
import CreatePEContent from "@/components/CreatePeContent"
import PEContentCard from "@/components/PEcard"
import { useGetAllPEContentQuery } from "@/lib/api"
...
function PreEngContentPage() {
  ...
  const { data: headings, isLoading, error } = useGetAllPreEngHeadingsQuery()
  const { data: studyPacks } = useGetAllPEContentQuery()
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="mb-8">
       <PEContentCard contents={filteredContents} error={error} isLoading={isLoading} />
       </div>
