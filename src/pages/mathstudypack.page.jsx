...
const pureMathsTopics = [
  {
    ...
    link: "/math-study-pack/pure/වර්ගජ-සමීකරණ ",
  },
  {
    title: "අසමානතා",
    description: "inequalities",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/අසමානතා",
  },
  {
    title: "ලඝු",
    description: "logs",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/ලඝු",
  },
  {
    title: "බහුපද ශ්‍රිත ",
    description: "Polynomial functions",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/බහුපද-ශ්‍රිත",
  },
  {
    title: "ත්‍රිකෝණමිතිය",
    description: "Trigonometric functions",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/ත්‍රිකෝණමිතිය",
  },
  {
    title: "සරල රේඛාව",
    description: "Straight lines",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/සරල-රේඛාව",
  },
  {
    title: "වෘත්තය",
    description: "Circles",
    icon: <Triangle className="h-6 w-6" />,
    link: "/math-study-pack/pure/වෘත්තය",
  },
  {
    title: "සීමා,අවකලනය",
    description: "Limit, differentiation",
    icon: <Compass className="h-6 w-6" />,
    link: "/math-study-pack/pure/සීමා-අවකලනය",
  },
  {
    title: "අනුකලනය",
    description: "Integration",
    icon: <Sigma className="h-6 w-6" />,
    link: "/math-study-pack/pure/අනුකලනය",
  },
  {
    title: "ශ්‍රේණි",
    description: "Grades",
    icon: <Infinity className="h-6 w-6" />,
    link: "/math-study-pack/pure/ශ්‍රේණි",
  },
  {
    title: "සංකීර්ණ සංඛ්‍යා",
    description: "Complex numbers",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/සංකීර්ණ-සංඛ්‍යා",
  },
  {
    title: "සංකරණ සහ සංයෝජන",
    description: "Conjunctions and disjunctions",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/සංකරණ-සහ-සංයෝජන",
  },
  {
    title: "න්‍යාස",
    description: "Matrices",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/න්‍යාස",
  },
  {
    title: "ද්විපද ප්‍රමේයය",
    description: "Binomial theorem",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/ද්විපද-ප්‍රමේයය",
  },
  {
    title: "ගණිත අභ්‍යූහනය",
    description: "Mathematical structure",
    icon: <Calculator className="h-6 w-6" />,
    link: "/math-study-pack/pure/ගණිත-අභ්‍යූහනය",
  },
]
...
const appliedMathsTopics = [
  {
    ...
    description: "Motion and motion graphs",
    icon: <TrendingUp className="h-6 w-6" />,
    link: "/math-study-pack/applied/චලිතය-හා-චලිත-ප්‍රස්තාර",
  },
  {
    title: "සාපේක්ෂ ප්‍රවේගය",
    description: "Relative velocity",
    icon: <BarChart3 className="h-6 w-6" />,
    link: "/math-study-pack/applied/සාපේක්ෂ-ප්‍රවේගය",
  },
  {
    title: "සාපේක්ෂ ත්වරණය",
    description: "Relative acceleration",
    icon: <CircleDot className="h-6 w-6" />,
    link: "/math-study-pack/applied/සාපේක්ෂ-ත්වරණය",
  },
  {
    title: "වෘත්ත චලිතය",
    description: "Circular motion",
    icon: <Cog className="h-6 w-6" />,
    link: "/math-study-pack/applied/වෘත්ත-චලිතය",
  },
  {
    title: "සරල අනුවර්තීය චලිතය",
    description: "Simple adaptive motion",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/සරල-අනුවර්තීය-චලිතය",
  },
    {
    title: "ගුරුත්ව කේන්ද්‍රය",
    description: "Center of gravity",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/ගුරුත්ව-කේන්ද්‍රය",
  },
    {
    title: "දෛශික",
    description: "Vectors",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/දෛශික",
  },
    {
    title: "බල සමතුලිතතාව",
    description: "Balance of power",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/බල-සමතුලිතතාව",
  },
    {
    title: "ඒක තල බල",
    description: "Co-planer Forces",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/ඒක-තල-බල",
  },
    {
    title: "සන්ධිකළ ඳඩු",
    description: "Jointed rods",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/සන්ධිකළ-ඳඩු",
  },
    {
    title: "බෝ අංකනය සහ රාමු සැකිලි",
    description: "Bo notation and frame templates",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/බෝ-අංකනය-සහ-රාමු-සැකිලි",
  },
    {
    title: "සම්භාවිතාව",
    description: "Probability",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/සම්භාවිතාව",
  },
    {
    title: "සංඛ්‍යානය",
    description: "The statistic",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/සංඛ්‍යානය",
  },
    {
    title: "ගෝල ගැටුම්",
    description: "Collisions of spheres",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/ගෝල-ගැටුම්",
  },
    ...
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/ප්‍රක්ෂිප්ත",
  },
    {
    title: "කාර්‍යය , ශක්තිය හා ක්ෂමතාවය",
    description: "Work, energy and efficiency",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/කාර්‍යය-ශක්තිය-හා-ක්ෂමතාවය",
  },
    {
    title: "නිවුටන් නියම",
    description: "Newton's laws",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/නිවුටන්-නියම",
  },
  {
    title: "ආවේග ආතති",
    description: "Impulsve Tension",
    icon: <Atom className="h-6 w-6" />,
    link: "/math-study-pack/applied/ආවේග-ආතති",
  },
]
